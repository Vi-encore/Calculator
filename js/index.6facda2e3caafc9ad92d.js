...
// alert("hello");
// console.log("bbb");
const changeBgBtn = document.querySelector(".calc__change-bg");

changeBgBtn.addEventListener("click", () => {
  const calc = document.querySelector(".calc");
  const changeBtn = document.querySelector(".calc__change-bg__btn");

  if (!calc.classList.contains("bg-color")) {
    calc.classList.add("bg-color");
    changeBtn.classList.add("change-color");
  } else {
    calc.classList.remove("bg-color");
    changeBtn.classList.remove("change-color");
  }
});
